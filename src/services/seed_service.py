        ...
        return [
            ...
            QuestionSchema(
                ...
                fields=[
                    ...
                    SchemaField(field_id="invoice_date", label=tr("schemas.zuzahlung.invoice_date_label", "Rechnungsdatum"), field_type=FieldType.DATE, required=True, placeholder=tr("schemas.zuzahlung.date_ph", "YYYY-MM-DD"), order=3),
                    ...
                    SchemaField(field_id="prescription_date", label=tr("schemas.zuzahlung.prescription_date_label", "Datum der Verordnung"), field_type=FieldType.DATE, required=True, placeholder=tr("schemas.zuzahlung.date_ph", "YYYY-MM-DD"), order=5),
