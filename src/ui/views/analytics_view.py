...
class AnalyticsView(ctk.CTkFrame):
    ...
    def render_dashboard(self):
        ...
        urg_frame = ctk.CTkFrame(left_col, fg_color=COLOR_PANEL_BG, border_width=1, border_color=COLOR_PANEL_BORDER, corner_radius=8)
        ...
        prac_frame = ctk.CTkFrame(right_col, fg_color=COLOR_PANEL_BG, border_width=1, border_color=COLOR_PANEL_BORDER, corner_radius=8)
        ...
        staff_frame = ctk.CTkFrame(right_col, fg_color=COLOR_PANEL_BG, border_width=1, border_color=COLOR_PANEL_BORDER, corner_radius=8)
        ...
        dept_frame = ctk.CTkFrame(right_col, fg_color=COLOR_PANEL_BG, border_width=1, border_color=COLOR_PANEL_BORDER, corner_radius=8)
