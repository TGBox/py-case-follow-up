...
class TableView(ctk.CTkFrame):
    """Sortable Data Matrix Table View with integrated collapsible Detail Pane."""
    ...
    def create_layout(self):
        ...
        # Table Header
        h_frame = ctk.CTkFrame(top_frame, height=36, fg_color=("gray75", "gray25"))
        h_frame.pack(fill="x", side="top", padx=5, pady=(5, 2))
